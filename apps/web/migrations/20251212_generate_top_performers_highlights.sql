-- Migration: Generate top performers highlights from real data
-- Description: Implements highlights calculation with real period-over-period variation:
--   - Query shifts joined with medical_staff and facilities
--   - Count shifts per staff member in current period
--   - Calculate variation comparing current to previous period
--   - Return top 3-5 performers with name, specialty, unit, volume, and variation percentage
